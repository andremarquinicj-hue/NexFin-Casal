...
export default function AppShell({children,title,subtitle}:{children:React.ReactNode;title:string;subtitle?:string}){
 ...
 return <div className="app-shell">
   <aside className={`sidebar ${mobile?"open":""}`}>
    <div className="brand"><div className="brand-mark"><Image src="/brand/nexfin-symbol.png" alt="Logo NexFin" width={42} height={42} priority /></div><div><strong>NexFin</strong><span>Finanças do casal</span></div></div>
